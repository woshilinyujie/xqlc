...
public class CheckNetType {
    ...
    public static boolean isWifiAvailable() {
        ConnectivityManager connectivityManager = (ConnectivityManager) CustomApplication.newInstance()
    ...
    public static boolean IsNetWorkEnable(Context context) {
        try {
            ...
            if (connectivity == null) {
                Toast.makeText(context, "无法连接网络,请检查您的网络", Toast.LENGTH_SHORT).show();
                return false;
            }
    ...
    public static String getProvider() {
        String provider = "未知";
        try {
            TelephonyManager telephonyManager = (TelephonyManager) CustomApplication.newInstance()
    ...
    private static int getNetworkClass() {
        ...
        try {
            final NetworkInfo network = ((ConnectivityManager) CustomApplication
                    .newInstance()
                    .getSystemService(Context.CONNECTIVITY_SERVICE))
    ...
    public static boolean checkSimState() {
        TelephonyManager tm = (TelephonyManager) CustomApplication.newInstance()
                .getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getImei() {
        TelephonyManager mTelephonyMgr = (TelephonyManager) CustomApplication.newInstance()
                .getSystemService(Context.TELEPHONY_SERVICE);
