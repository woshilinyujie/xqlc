...
public class PrincipalBeen implements Serializable{
    ...
    public void setKqNum(String kqNum){
        this.kqNum=kqNum;
    ...
    public String getHbkyye() {
        return hbkyye;
    }

    public void setHbkyye(String hbkyye) {
        this.hbkyye = hbkyye;
    }
    ...
    public String getTjfriendjl() {
        return tjfriendjl;
    }

    public void setTjfriendjl(String tjfriendjl) {
        this.tjfriendjl = tjfriendjl;
    }
    ...
    public String getZjhkts() {
        return zjhkts;
    }

    public void setZjhkts(String zjhkts) {
        this.zjhkts = zjhkts;
    }
