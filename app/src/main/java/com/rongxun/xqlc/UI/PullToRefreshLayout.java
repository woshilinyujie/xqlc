...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private int lastPosition;//屏幕下可见的位置
    ...
    Handler updateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (pullDownY < 0) {
                ...
                /////////////////////////////
                // TODO: 2017/8/10 0010 下拉完成
                if (stateListener != null) {
                    stateListener.finishDown();
                }
                //////////////////////////////
            }
            if (pullUpY > 0) {
    ...
    private void initView(Context context) {
        ...
        refreshView = inflater.inflate(R.layout.refresh_head, this,
                false);
        loadmoreView = inflater.inflate(R.layout.load_more, this, false);
        addView(refreshView);
     ...
     * @param delay         延时多少秒
     */
    public void delayRefreshFinish(final int refreshResult, int delay) {
    ...
    public void loadmoreFinish(final int refreshResult) {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                delayLoadMoreFinish(refreshResult);
            }
        }, 200);
    }

    /**
     * 如果加载时间过短的话，由于视觉暂留的原因
     * 加载转圈的那个动画会出现错位现象，
     * 所以延时200毫秒
     *
     * @param refreshResult
     */
    private void delayLoadMoreFinish(int refreshResult) {
...
//                loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
            ...
            case NOMORE:
//                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.no_more);
//                loadStateImageView.setBackgroundResource(R.drawable.load_succeed);
                break;
            case FAIL:
            default:
...
//                loadStateImageView.setBackgroundResource(R.drawable.load_failed);
    ...
    private void initView() {
        ...
        imgRefreshing = (ImageView) refreshView.findViewById(R.id.img_frame);
        //////////////////初始化下拉刷新动画///////////////////////////
        animationDrawable = (AnimationDrawable) imgRefreshing.getBackground();
...
//        void  loadFinish();
//    }
//    private OnLoadFinish finish;
//
//    public void setFinish(OnLoadFinish finish) {
//        this.finish = finish;
//    }
