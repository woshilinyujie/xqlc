...
public class LoadListViewHongbao extends ListView implements OnScrollListener, Pullable {
    ...
    public LoadListViewHongbao(Context context) {
        super(context);
    ...
    public LoadListViewHongbao(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }

    public LoadListViewHongbao(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        rootView = LayoutInflater.from(mContext).inflate(R.layout.list_load_more_footer_hongbao, null);
