...
public class LoadListView extends ListView implements OnScrollListener, Pullable {
    ...
    private void init() {
        ...
        rootView = LayoutInflater.from(mContext).inflate(R.layout.list_load_more_footer, null);
