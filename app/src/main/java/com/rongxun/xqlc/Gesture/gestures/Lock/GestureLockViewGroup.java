package com.rongxun.xqlc.Gesture.gestures.Lock;
...
import com.rongxun.xqlc.Gesture.gestures.Util.AppConstants;
import com.rongxun.xqlc.Gesture.gestures.Util.PreferenceUtil;
...
public class GestureLockViewGroup extends RelativeLayout {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            dialog.setMessage("手势密码输入错误次数已达到上限，请您重新登录");
            dialog.setMtitle("确定");
            dialog.show();
...
//                mChoose = new StringBuilder();
    ...
    public void RequestForLogout(String basicUrl) {
        ...
        OkHttpUtils.post()
                .url(basicUrl)
                .addParams("token", com.rongxun.xqlc.Util.PreferenceUtil.getPrefString(context, "loginToken", ""))
                .build()
