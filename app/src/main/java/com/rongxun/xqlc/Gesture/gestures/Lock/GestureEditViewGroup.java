...
public class GestureEditViewGroup extends RelativeLayout
{
     ...
     * 是否第一次输入手势
     */
    private boolean isFirestInput = true;

    /**
     * 回调接口
     */
    private OnGestureEditViewListener onGestureEditViewListener;

    public GestureEditViewGroup(Context context, AttributeSet attrs)
    {
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        switch (action)
        {
            ...
            case MotionEvent.ACTION_UP:
                ...
                // 回调是否成功
                if (onGestureEditViewListener != null && mChoose.length() > 0)
                {
                   if(isFirestInput){
                       onGestureEditViewListener.onFirstInputCompleted(mChoose.toString());
                       reset();
                   }else{
                       onGestureEditViewListener.onSecondInputCompleted(mChoose.toString());
                       reset();
     ...
     * @param listener
     */
    public void setOnGestureEditViewListener(OnGestureEditViewListener listener)
    {
        this.onGestureEditViewListener = listener;
    }
    ...
    public interface OnGestureEditViewListener
    {
         ...
         * @param inputText
         */
        public void onFirstInputCompleted(String inputText);
         ...
         * @param inputText
         */
        public void onSecondInputCompleted(String inputText);
