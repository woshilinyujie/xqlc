...
import com.rongxun.xqlc.Beans.user.MyFriendBean;
...
public class HongBaoFriendsAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
            hongBaoFriendsItemId = (TextView) view.findViewById(R.id.hong_bao_friends_item_id);
            hongBaoFirendsItemDate = (TextView) view.findViewById(R.id.hong_bao_firends_item_date);
            hongBaoFirendsItemAward = (TextView) view.findViewById(R.id.hong_bao_firends_item_award);
        }
    }
}
