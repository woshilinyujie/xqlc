...
public class ProjectTenderHongBaoAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
            tenderHbItemCheckBox = (CheckBox) view.findViewById(R.id.tender_hb_item_check_box);
            tenderHbItemMoney = (TextView) view.findViewById(R.id.tender_hb_item_money);
            tenderHbItemDate = (TextView) view.findViewById(R.id.tender_hb_item_date);
        }
    }
