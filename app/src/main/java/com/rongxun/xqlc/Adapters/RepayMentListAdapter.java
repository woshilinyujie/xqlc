...
import com.rongxun.xqlc.Beans.center.UserRepayment;
...
public class RepayMentListAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
            repayMentListItemName = (TextView) view.findViewById(R.id.repay_ment_list_item_name);
            repayMentListItemBorrowCount = (TextView) view.findViewById(R.id.repay_ment_list_item_borrow_count);
            tenderRecordItemTime = (TextView) view.findViewById(R.id.tender_record_item_time);
            repayMentListItemProfit = (TextView) view.findViewById(R.id.repay_ment_list_item_profit);
        }
    }
}
